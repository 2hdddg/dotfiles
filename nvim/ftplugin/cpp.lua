...
local client_id = vim.lsp.start({
    name = 'clangd',
    cmd = { "clangd-19", "--query-driver=**-poky-*", "--all-scopes-completion", "--offset-encoding=utf-16", "--background-index", "--clang-tidy", "--header-insertion=iwyu", "--header-insertion-decorators", "--completion-style=detailed", "--pretty" },
